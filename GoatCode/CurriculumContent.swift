...
let U2_L3_Q2: [String] = ["Bob and Alice want to combine their goats into one herd. However, they hate doing math. If there is a integer ‘bobsGoats’ and an integer ‘alicesGoats’, create a variable ‘totalGoats’ and set it equal to the total.",
...
let U4_L2_Q1: [String] = ["“fakeNews” is a string variable, which contains the string “goatsSuck”. Create a new variable named “trueNews”, and set it equal to the first five letters of the “fakeNews” with slicing. In other words, slice the word “goats” out of the fakeNews variable, and put it in trueNews.",
                          "trueNews = fakeNews(:4)",
                          "trueNews = fakeNews[:5]",
                          "trueNews = fakeNews[:4]",
                          "trueNews = fakeNews",
...
let unit3_lesson1: [String] = [
    ...
    "age = 12\nif age == 18:\n    print(\"You are 18 years old!\")\nelif age == 13:\n    print(\"You are 13 years old!\")\n\nIn this code, the first if condition is false, but the elif condition is true because “age” is equal to 12.",
...
let unit4_lesson2: [String] = [
    ...
    "sentence = \"Hello, world!\"\nprint(sentence[:5])  # Output: \"Hello\"\nprint(sentence[7:])  # Output: \"world!\"\n\nIn this code, “sentence[:5]” slices the string from the beginning to index 4 (excluding 5), giving us \"Hello\". “sentence[7:]” slices the string from index 7 to the end, resulting in \"world!\".",
...
let unit4_lesson3: [String] = [
    ...
    "In this code, we have a dictionary called “student”. The keys are \"name\", \"age\", and \"grade\", and their corresponding values are \"Emma\", 14, and 9, respectively.",
    ...
    "This code updates the value of the \"grade\" key to 12. Now, “student[\"grade\"]” will give us the updated value.",
    "To add a new key-value pair, you simply assign a value to a new key:\n\nstudent[\"school\"] = \"High School\"",
    "This code adds a new key \"school\" with the value \"High School\" to the “student” dictionary.",
...
let unit6_lesson2: [String] = [
    ...
    "def greet(name):\n    print(\"Hello, \" + name + \"! Welcome to the program!\")\n\ngreet(\"Alice\")  # Output: Hello, Alice! Welcome to GoatCode!\n\nWe modified our “greet()” function to take argument “name”. When we call the function and pass \"Alice\", it uses that value to customize the message it prints.",
